...
import static com.example.prasadsawant.govtscheme.R.id.textView3graminbhand;
import static com.example.prasadsawant.govtscheme.R.id.tv1;
import static com.example.prasadsawant.govtscheme.R.id.tv1graminbhand;

/**
 * Created by prasad sawant on 14-04-2017.
 */

public class tempFarmer3 extends AppCompatActivity{
    TextView tv;
    TextView tv11;
    Firebase fb;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.on_click_graminbhandharan);

        Firebase.setAndroidContext(this);
        tv = (TextView)findViewById(textView3graminbhand);
        tv11 = (TextView)findViewById(tv1graminbhand);


        ///////////////
        tv11.setClickable(true);
        tv11.setMovementMethod(LinkMovementMethod.getInstance());
        String text = "<a href='http://pib.nic.in/newsite/mbErel.aspx?relid=96201'>read more...</a>";
...
//        Firebase fb1 = fb.child("url");
        Firebase fb_content = fb.child("content4");
